...
class Movie(models.Model):
    ...
    year = models.PositiveIntegerField("Data of release", default=2019)
    ...
    budget = models.PositiveIntegerField("Budget", default=0, help_text="show amount in dollars")
    fees_in_usa = models.PositiveIntegerField("Fees in USA", default=0, help_text="show amount in dollars")
    fees_in_world = models.PositiveIntegerField("Fees in world", default=0, help_text="show amount in dollars")
